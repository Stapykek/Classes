...
namespace mylib {
/*
Принцип работы односвязного списка: список хранит узлы, а также адреса первого и последнего узла.
узел - тоже класс/структура, хранящая значение узла и адрес следующего узла.
*/
